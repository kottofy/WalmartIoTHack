...
static const char* connectionString = "HostName=edgev2test-2.azure-devices.net;DeviceId=store-1-edge;SharedAccessKey=mcH5MMe1eyLG3sQkSQRY2VpwePVq+8w7trlk0pMcXR4=";
